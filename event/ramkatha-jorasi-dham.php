...
<header class="site-header">
  <div class="header-container">
    ...
    <!-- Logo -->
    <div class="logo">
      <img src="images/logo.png" alt="Mobile Mandir Logo">
    </div>
...
<section class="event-page">
  ...
  <!--<button class="store-btn apple"> Available on the App Store</button>
      <button class="store-btn google">▶ Available on Google Play</button>-->
      <a class="app-download-image-appstore" href=""><img src="images/appstore.png"></a>
      <a class="app-download-image-playstore" href=""><img src="images/playstore.png"></a>
    </div>
...
<div class="banner-section-bottom">
  <div class="banner-slider">
    <div class="banner-slide"><img src="images/banner-bottom.jpg"></div>
    <div class="banner-slide"><img src="images/banner-bottom-1.jpg"></div>
    <div class="banner-slide"><img src="images/banner-bottom-2.jpg"></div>
    <div class="banner-slide"><img src="images/banner-bottom-3.jpg"></div>
  </div>
</div>
...
<div class="content" id="faq">
  <p><strong>Q1.</strong> What is this app?</p>
  <p>This app provides devotional services.</p>
</div>

<div class="info-card" onclick="toggleContent(this, 'terms')">
  <div class="left">
...
<!-- <footer class="footer">
  ...
  <div class="footer-bottom">
    <p>© 2025 Mobile Mandir. All rights reserved.</p>
    <p class="designed-and-developed-text">Designed & Developed by <a><img src="images/seoily-logo.png"></a></p>
  </div>
 </div>
</footer>
 -->
...
<div class="event-fixed-footer-container">

<div class="event-fixed-footer-outer">
<div>
...
<div class="fixed-footer-right-side">
